...
class ResearchMethod(BaseModel):
    ...
    rounding_type: Mapped[str] = mapped_column(
        String(20), nullable=False, comment="Тип округления"
    )
    rounding_decimal: Mapped[int] = mapped_column(
    ...
    calculations: Mapped[list["Calculation"]] = relationship(
        back_populates="research_method"
    )
    refraction_tables: Mapped[list["MassFractionOilRefractionTable"]] = relationship(
        back_populates="research_method"
    )
