            ...
            <section className="help-guide-section">
              ...
              <ol className="help-guide-steps">
                ...
                <li className="help-guide-step">
                  ...
                  <span className="help-guide-step-text">
                    При необходимости заполните приборы, места отбора проб и нормы НД.
                  </span>
                </li>
                <li className="help-guide-step">
                  <span className="help-guide-step-title">Роли и права</span>
                  <span className="help-guide-step-text">
                    В «Роли» создайте роли лаборанта или инженера, назначьте вкладки и права, затем
                    выдайте доступ сотрудникам.
                  </span>
                </li>
              </ol>
            </section>
