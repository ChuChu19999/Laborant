              ...
              <ol className="help-guide-steps">
                <li className="help-guide-step">
                  ...
                  <span className="help-guide-step-text">
                    В «Управление лабораториями» создайте и при необходимости удалите лаборатории и
                    подразделения (только admin). Редактирование карточек и настройки шаблонов
                    доступны при праве «Управление лабораториями».
                  </span>
                </li>
                <li className="help-guide-step">
                ...
                <li className="help-guide-step">
                  ...
                  <span className="help-guide-step-text">
                    ...
                    права отдельно: доступ к разделу в одной лаборатории не открывает его в другой.
                    Затем выдайте доступ сотрудникам.
                  </span>
                </li>
              </ol>
            </section>
            ...
            <div>
              ...
              <ul className="list">
                ...
                <li className="list-item">
                  Доступ к разделам и справочникам проверяется по правам выбранной лаборатории и
                  подразделения, а не только по наличию привязки
                </li>
                <li className="list-item">
                  Создавать и удалять лаборатории и подразделения может только admin
                </li>
                <li className="list-item">
