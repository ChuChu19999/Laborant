import { usePermissionsContext } from '@/entities/Role';
        ...
        <div className="help-page-content">
          ...
          <section className="help-guide-section">
            ...
            <ol className="help-guide-steps">
              <li className="help-guide-step">
                ...
                <span className="help-guide-step-text">
                  Откройте «Поступления проб», выберите лабораторию и подразделение, добавьте пробу.
                </span>
              </li>
              <li className="help-guide-step">
          ...
          <section className="help-guide-section">
            ...
            <div>
              ...
              <ul className="list">
                <li className="list-item">
                  Добавлена страница «Мониторинг» в разделе администрирования
                </li>
              </ul>
              <p className="version-title">Версия 1.0.4:</p>
              <ul className="list">
                <li className="list-item">
                  Создание и удаление лабораторий и подразделений доступны только администратору
                </li>
                <li className="list-item">
                  Ускорена начальная загрузка системы за счёт снижения объёма данных, передаваемых
                  при открытии приложения
                </li>
                <li className="list-item">
                  Улучшена отзывчивость при работе со списками: данные обновляются аккуратнее при
                  возврате к разделу и повторном открытии вкладок
                </li>
              </ul>
              ...
              <ul className="list">
                ...
                <li className="list-item">
                  Добавлена вкладка «Пробы» — теперь добавление расчётов производится через эту
