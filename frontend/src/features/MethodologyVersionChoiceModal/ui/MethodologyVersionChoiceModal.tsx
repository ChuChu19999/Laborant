...
import type { MethodologyChoice } from '@/entities/Calculation';
...
const MethodologyVersionChoiceModal = ({
  open,
  choice,
  onChooseStored,
  onChooseCurrent,
  onCancel,
}: MethodologyVersionChoiceModalProps) => {
          ...
          {isAmbiguous ? (
            <div className="methodology-version-choice-modal-candidates">
              ...
              <RadioGroup
                ...
                onChange={event => {
                  const nextValue: unknown = event.target.value;
                  setSelectedCandidateId(typeof nextValue === 'number' ? nextValue : null);
                }}
