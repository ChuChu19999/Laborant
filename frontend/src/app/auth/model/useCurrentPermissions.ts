...
import { defaultRolePermissions, type UserPermissions } from '@/entities/Role';
import { userRoleApi } from '../api/userRole';
import { userRoleKeys } from '../api/userRoleKeys';
...
/** Права «отказ» до загрузки ответа /user-roles/me/. */
...
/** Загружает права текущего пользователя после готовности Keycloak. */
