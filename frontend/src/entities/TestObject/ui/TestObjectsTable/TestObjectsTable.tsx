...
import { TableFilterTheme } from '@/shared/ui/TableFilter';
import { TablePagination } from '@/shared/ui/TablePagination';
import { TableSortIcon } from '@/shared/ui/TableSortIcon';
import { createTestObjectsTableColumns } from './testObjectsTableColumns';
...
const TestObjectsTable = ({
  ...
  const columns = React.useMemo(
    () => createTestObjectsTableColumns({ onEdit, onDelete, canUpdate, canDelete }),
                      ...
                      {headerGroup.headers.map(header => (
                        ...
                        >
                          {header.column.getCanSort() ? (
                            <button
                              type="button"
                              className="test-objects-table-header-content sortable"
                            ...
                            <div className="test-objects-table-header-content">
                              {flexRender(header.column.columnDef.header, header.getContext())}
                            </div>
                          )}
                      ...
                      <tr className="test-objects-table-filter-row">
                        {headerGroup.headers.map(header => (
                          <th
                            ...
                            className="test-objects-table-filter-cell"
                          >
